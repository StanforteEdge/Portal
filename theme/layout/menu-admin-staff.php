        ...
        <div class="intro-y box mt-5 lg:mt-0">
            <div class="relative flex items-center p-5">
                ...
                <div class="ml-4 mr-auto">
                    <div class="font-medium text-base"><?= $viewstaff->first_name . ' ' . $viewstaff->last_name; ?></div>
                    ...
                    <div class="dropdown-menu w-56">
                        <ul class="dropdown-content">
                            <div class="p-5 sm:hidden border-slate-200/60 dark:border-darkmode-400">
                                <a href="/profile" class="flex items-center <?php if (is_page('profile')) {
                                                                                        echo 'text-primary font-medium';
                                                                                    } ?>  " href=""> <i data-lucide="activity" class="w-4 h-4 mr-2"></i> Overview </a>
                                <a href="/profile/jd/" class="flex items-center <?php if (is_page('profile/jd')) {
                                                                                        echo 'text-primary font-medium';
                                                                                    } ?> mt-5" href=""> <i data-lucide="box" class="w-4 h-4 mr-2"></i> Job Description </a>
                                <a href="/profile/bio/" class="flex items-center <?php if (is_page('profile/bio')) {
                                                                                        echo 'text-primary font-medium';
                                                                                    } ?> mt-5" href=""> <i data-lucide="lock" class="w-4 h-4 mr-2"></i> Personal Information </a>
                                <a class="flex items-center mt-5" href=""> <i data-lucide="settings" class="w-4 h-4 mr-2"></i> <Source:media></Source:media>taff Details </a>
                            </div>
                            <div class="p-5 sm:hidden border-t border-slate-200/60 dark:border-darkmode-400">
            ...
            <div class="p-5 border-t hidden sm:block border-slate-200/60 dark:border-darkmode-400">
                <a href="/profile" class="flex items-center <?php if (is_page('profile')) {
                                                                                        echo 'text-primary font-medium';
                                                                                    } ?> hover:font-medium" href=""> <i data-lucide="activity" class="w-4 h-4 mr-2"></i> Overview </a>
                <a href="/profile/jd/" class="flex items-center <?php if (is_page('profile/jd')) {
                                                                                        echo 'text-primary font-medium';
                                                                                    } ?> mt-5 hover:font-medium " href=""> <i data-lucide="box" class="w-4 h-4 mr-2"></i> Job Description </a>
                <a href="/profile/bio/" class="flex items-center <?php if (is_page('profile/bio')) {
                                                                                        echo 'text-primary font-medium';
                                                                                    } ?> hover:font-medium mt-5" href=""> <i data-lucide="lock" class="w-4 h-4 mr-2"></i> Personal Information</a>
