<?php /* Template Name:  Staff: Requests - Approvals */
?>

<?php
get_header();
$b_link = '/requests/approvals';
$b_title = 'Request Approvals';
$p_title = 'View Request';
...
<div id="menu-sort" class="intro-y hidden md:block w-full gap-3 mt-5">
    <div class="flex sm:w-auto items-center justify-center align-center">
        ...
        <select id="show-status" class="w-32 mr-2 form-select box  sm:mt-0">
            <option value="6,7,8,9,10,11,12,13,14" selected>Status </option>
        ...
        function checkStatus(status) {
            let stat;
             if (status == 6) {
                ...
                stat = '<div class="text-success">Unconfirmed</div>';
            } else if (status == 12) {
                stat = '<div class="text-success">Unretired</div>';
            } else if (status == 13) {
