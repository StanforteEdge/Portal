...
import { clockIn, clockOut, getMyAttendance, type AttendanceDaily, type AttendanceEntry } from "@/services/hr";
...
function StaffAttendancePage() {
  ...
  const statsCards = useMemo(() => {
    ...
    return [
      ...
      { label: "Total Days", value: daily.length, icon: "BarChart2", color: "text-primary" },
    ];
  }, [daily]);
