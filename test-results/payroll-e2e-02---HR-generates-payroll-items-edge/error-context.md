...
- Name: payroll-e2e.spec.ts >> 02 - HR generates payroll items
- Location: e2e/payroll-e2e.spec.ts:54:5
...
Locator: locator('button:has-text("Generate Items")').first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Generate Items")').first()
