...
- Name: payroll-e2e.spec.ts >> 01 - HR creates a payroll run
- Location: e2e/payroll-e2e.spec.ts:30:5
...
Call log:
  - waiting for locator('button:has-text("Create Run")').first()
    ...
    - generic [ref=e12]:
      ...
      - generic [ref=e15]:
        - generic [ref=e16]:
          ...
          - generic [ref=e18]:
            - generic: mail
            - textbox "Work Email" [active] [ref=e19]:
              - /placeholder: name@stanforteedge.com
              - text: E2E Test Run 1778422950373
        - generic [ref=e20]:
          - generic [ref=e21]:
