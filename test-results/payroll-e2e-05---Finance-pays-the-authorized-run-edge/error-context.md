...
- Name: payroll-e2e.spec.ts >> 05 - Finance pays the authorized run
- Location: e2e/payroll-e2e.spec.ts:110:5
...
Locator: locator('text="undefined"').first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for locator('text="undefined"').first()
