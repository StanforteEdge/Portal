<?php
/**
 * Template Name: Finance: Settings - Payment Methods
 * Description: Configure payment channels and bank accounts
 */
...
$activeMenu = 'finance-settings-payment-methods';
...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        ...
        <p class="text-gray-500 mt-1">Configure payment channels, bank accounts, and limits</p>
    </div>
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-8 text-center">
        ...
        <p class="text-gray-600 mb-6 max-w-2xl mx-auto">
            Payment Methods configuration will be available soon. Set up bank accounts,
            configure payment channels, and define transaction limits.
        </p>
