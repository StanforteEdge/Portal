...
/**
 * FinanceRequestData Model (EAV)
 * 
 * Stores Finance request field values with type-specific columns
 */
class FinanceRequestData extends BaseModel
{
    protected $table = 'sta_finance_request_data';
    ...
    {
        global $wpdb;
        $table = $wpdb->prefix . 'sta_finance_request_data';
