...
/**
 * AdminRequestData Model (EAV)
 * 
 * Stores Admin request field values with type-specific columns
 */
class AdminRequestData extends BaseModel
{
    protected $table = 'sta_admin_request_data';
    ...
    {
        global $wpdb;
        $table = $wpdb->prefix . 'sta_admin_request_data';
