...
class Migration_1_6_5_EnsureRequestInstancesTable
{
    public static function up()
    {
        ...
        error_log('Running Migration 1.6.5: Ensure Request Instances Table Exists');
        ...
        // 3. Request Instances table (THE MAIN TABLE)
        ...
        error_log('Migration 1.6.2 completed: Request system tables ensured');
    }
