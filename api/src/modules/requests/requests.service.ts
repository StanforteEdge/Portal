  ...
  async updateType(id: string, dto: UpdateTypeDto, actorId?: string) {
    ...
    return this.prisma.requestType.update({
      ...
      data: {
        ...
        workflowType: dto.workflow_type !== undefined ? dto.workflow_type : undefined,
        handlerRoleLabel: dto.handler_role_label !== undefined ? dto.handler_role_label : undefined,
      }
    });
  }
