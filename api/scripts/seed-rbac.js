...
const roles = [
  ...
  { name: 'Procurement Officer', slug: 'procurement_officer', description: 'Reviews and approves procurement requests' },
...
const rolePermissionMap = {
  ...
  procurement_officer: ['requests.view', 'requests.approve', 'groups.view', 'projects.view', 'workflow.view'],
